        ...
        <div className="space-y-8">
          <div>
            ...
            <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
              <p>
                Olá! Sou <span className="text-slate-200 font-medium">Weslley Carlos</span>, servidor público federal e desenvolvedor full-stack nas horas vagas. Minha relação com tecnologia nasceu da vontade de criar soluções que tornem processos mais eficientes e inteligentes.
              </p>
              <p>
                No serviço público, aprendi organização, responsabilidade e foco em resultados — habilidades que aplico diretamente no desenvolvimento de software, buscando sempre escrever código claro, escalável e objetivo.
              </p>
              <p>
                Tenho me aprofundado em <span className="text-accent-400 font-medium">Python, TypeScript, React, Node.js e PostgreSQL</span>, com o objetivo de criar aplicações completas, da modelagem do banco de dados ao deploy.
              </p>
            </div>
          </div>
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="bg-slate-950/50 backdrop-blur-md p-4 rounded-xl border border-white/10">
                  ...
                  <p className="font-mono text-xs text-slate-400">
                    ...
                    &nbsp;&nbsp;nome: <span className="text-green-400">"Weslley Carlos"</span>,<br/>
